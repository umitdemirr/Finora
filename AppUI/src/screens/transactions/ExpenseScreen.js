  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerCard}>
        <Text style={styles.headerTitle}>Toplam Gider</Text>
        <Text style={styles.headerAmount}>₺{totalExpense.toLocaleString('tr-TR', { minimumFractionDigits: 2 })}</Text>
      </View>
      ...
      <View style={styles.categorySummary}>
        <Text style={styles.sectionTitle}>Kategori Bazlı Giderler</Text>
            ...
            <View style={styles.transactionLeft}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      expenseCategories.find((c) => c.id === transaction.category)?.color + '20',
                  },
                ]}
              >
                <Icon
                  name={expenseCategories.find((c) => c.id === transaction.category)?.icon}
                  size={24}
                  color={expenseCategories.find((c) => c.id === transaction.category)?.color}
                />
              </View>
